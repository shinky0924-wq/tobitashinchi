...
export default function JobWorkflow() {
  const steps = [
    ...
    },
    {
      ...
      title: 'お見送り・お部屋の整頓',
      icon: 'HandHeart',
      image: '/images/col_welcome_gift_1783883703745.jpg',
      imageAlt: 'お見送りとお土産のキャンディ・ガム',
      desc: '終了チャイムが鳴ったら身支度を整え、玄関でお土産のキャンディやガムをお渡ししてお見送りします。お部屋を綺麗に整えたら、再び玄関先での待機（ステップ02）に戻ります。'
    },
    {
      step: '06',
      time: 'シフト終了・退勤',
      ...
      imageAlt: '全額当日日払い手渡し',
      desc: 'その日のシフトが終了したら退勤です。稼いだお給料を全額日払い（手渡し）で受け取って帰宅できます。ノルマや罰金、雑費天引きは一切なく、稼いだ全額がそのまま手元に残ります。'
    }
  ];
