    ...
    <section className="py-20 bg-white" id="jobs">
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="mb-16">
          ...
          {/* Visual Benefit Showcases: Daily Cash & Luxury Studio Dormitory */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <motion.div
              ...
              className="group bg-white rounded-3xl overflow-hidden border border-rose-100/80 shadow-xs hover:shadow-md transition-all flex flex-col sm:flex-row"
            >
              <div className="sm:w-48 h-48 sm:h-auto shrink-0 relative overflow-hidden">
                <img
                  src="/images/col_salary_savings_1789107442335.jpg"
                  alt="全額即日日払い手渡し"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  loading="lazy"
                  referrerPolicy="no-referrer"
                />
                <span className="absolute top-3 left-3 bg-secondary text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-xs">
                  全額日払い
                </span>
              </div>
              <div className="p-5 flex-1 flex flex-col justify-center">
                <h4 className="font-display font-bold text-base text-on-surface mb-1.5 group-hover:text-secondary transition-colors">
                  稼いだその日に全額現金手渡し
                </h4>
                <p className="text-xs text-on-surface-variant leading-relaxed mb-3">
                  雑費・備品代・衣装代などの不当な天引きは完全ゼロ円。急な出費や借金返済、貯金目標にも心強い完全手渡しシステムです。
                </p>
                <div className="inline-flex items-center gap-1.5 text-xs font-bold text-secondary">
                  <LucideIcon name="CheckCircle2" size={14} />
                  <span>天引き・雑費完全0円保証</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="sm:w-48 h-48 sm:h-auto shrink-0 relative overflow-hidden">
                <img
                  src="/images/col_studio_room_1789107471455.jpg"
                  alt="家具家電付き個室マンション寮完備"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  loading="lazy"
                  referrerPolicy="no-referrer"
                />
              ...
              <div className="p-5 flex-1 flex flex-col justify-center">
                ...
                <p className="text-xs text-on-surface-variant leading-relaxed mb-3">
                  Wi-Fi・エアコン・ベッド・冷蔵庫完備。カバンひとつで上京や新生活をスタート可能。オートロック付きで防犯・プライバシーも万全です。
                </p>
                <div className="inline-flex items-center gap-1.5 text-xs font-bold text-secondary">
                  <LucideIcon name="CheckCircle2" size={14} />
                  <span>遠方からの赴任・引越し支援</span>
                </div>
              </div>
            </motion.div>
          </div>
