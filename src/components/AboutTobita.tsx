...
export default function AboutTobita() {
  const points = [
    ...
    },
    {
      icon: 'CameraOff',
      title: '盗撮禁止・警備員常駐',
      desc: '街全体の厳格なルールとしてエリア内での写真・動画撮影は一切禁止されており、専属の警備員や見回りが常駐して女の子の安全とプライバシーを徹底して守っています。盗撮や身バレの心配がなく、安心して働ける環境が整っています。'
    },
    {
      icon: 'UserCheck',
      title: '写真指名なし・完全実物指名',
      desc: 'ネットの写真指名やパネル写真、写メ日記は一切ありません。お客様は料亭の玄関先で直接あなたを見て選ぶ「完全実物指名」のため、写真加工のプレッシャーや「写真と違う」といったクレームの心配が一切なく、ありのままの自然体で安心して働けます。'
    }
  ];
